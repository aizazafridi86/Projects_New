...
namespace EA_Visualization_Software.PSO_Algorithm
{
    public class CalculateGBest
    {
        ...
        //method that returns the index of best particle in each time step (for minimization problem)
        ...
        public int Return_gbest_Maximization(List<Particle> particle, int numberOfParticles)
        {
            //Initially assuming that particle[0] has the best fitness
            this.bestParticle_index = 0;
